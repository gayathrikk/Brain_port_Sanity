...
public class Brain_homepage {
	...
	public void homepagecontent() {
		...
		WebElement text4 = driver.findElement(By.xpath(
				"//div[@class='col-md-4 col-lg-4 footer-mb-5']//h3[contains(text(), 'Address')]/following-sibling::p"));
		...
		WebElement tableRow = driver.findElement(By.xpath(
				"//tr[th[text()='Brains'] and th[text()='Gestation week(GW)'] and th[text()='Sectioning Plane'] and th[text()='Available Datasets'] and th[text()='Annotations'] and th[text()='Volumes'] and th[text()='Videos']]"));
	...
	public void LinkValidation() {
		...
		// Define your XPath values for multiple links (including the new one you
		// mentioned)
